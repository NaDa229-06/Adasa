...
export default function ArticleCard ({ article, index }) {
  return (
    ...
    >
      {/* استخدمنا slug لتكوين الرابط */}
      <a className="block" href={`/blog/${article.slug}`} data-discover="true">
        <div className="grid md:grid-cols-2 gap-0">
          <div className="relative h-72 md:h-[400px] overflow-hidden">
            {/* استخدمنا image بدلا من imageUrl */}
            <img 
              alt={article.title} 
            ...
            {/* استخدمنا featured بدلا من isFeatured */}
            {article.featured && (
          ...
          <div className="p-8 md:p-10 flex flex-col justify-center bg-[#161616]">
            ...
            {/* استخدمنا excerpt بدلا من description */}
            ...
            <div className="flex items-center justify-between mt-auto">
              <div className="flex items-center gap-3">
                <div className="relative">
                  {/* استخدمنا article.author.avatar بدلا من avatarUrl */}
