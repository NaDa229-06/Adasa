    ...
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
      ...
      <div>
        ...
        <form className="space-y-3">
          ...
          <button type="submit" className="w-full btn-primary text-sm px-5 py-3 rounded-full bg-gradient-to-r from-orange-500 to-orange-600 text-white font-bold hover:from-orange-600 hover:to-orange-700 hover:shadow-orange-500/50 hover:scale-105 transition-all duration-300">اشترك</button>
        </form>
      </div>
    </div>
  </div>
