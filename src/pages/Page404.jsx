...
export default function Page404() {
  return (
    <div className='flex-grow pt-20'>
        <div className="min-h-[calc(100vh-5rem)] flex items-center justify-center relative overflow-hidden bg-[#0a0a0a] pb-10">
  ...
  <div className="relative text-center px-4 max-w-lg mx-auto">
    ...
    <div className="pt-8 border-t border-[#262626]">
      ...
      <div className="flex flex-wrap justify-center gap-4 text-sm">
        <a className="text-orange-500 hover:text-orange-400 hover:underline font-medium" href="/blog" data-discover="true">
          المدونة
        </a>
        <span className="text-neutral-600">•</span>
        <a className="text-orange-500 hover:text-orange-400 hover:underline font-medium" href="/about" data-discover="true">
          من نحن
        </a>
        <span className="text-neutral-600">•</span>
        <a className="text-orange-500 hover:text-orange-400 hover:underline font-medium" href="/privacy" data-discover="true">
          الخصوصية
        </a>
      </div>
    </div>
