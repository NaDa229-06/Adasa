...
export default function About() {
  ...
  <div className="relative max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
    ...
    <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-white my-6">
    ...
    <div className="grid grid-cols-2 md:grid-cols-4 gap-4 max-w-4xl mx-auto">
      <div className="glass-card rounded-3xl border border-[#3a3a3a] bg-[#1a1a1a]/90 px-6 py-5 text-center shadow-lg shadow-black/20 transition-all duration-300 hover:-translate-y-2 hover:border-orange-500/40 hover:shadow-orange-500/10">
        <i className="fa-solid fa-users text-2xl text-orange-500 mb-2 block"></i>
        <div className="text-3xl font-bold text-orange-500 mb-1">+2مليون</div>
